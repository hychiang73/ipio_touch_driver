...
When the version of image is built for the user, most of ways to debug are not allowd to utilize like as the above. But what if we just want to see the data generated by firmware while thouching, can we just dump it without any write actions in kernel ?

Yes, the read-only action is approval by android. Based on the concept, we design a flag as switch to enable the feature within a particular device node.

```
$ cat /proc/ilitek/report_data
```

Once you type the command, you will immediately see finger report data while toucning on screen. The print looks like this :

```
<4>[  554.562446] ILI_DATA: ----------------------
<4>[  554.569239] ILI_DATA:  0x5a
<4>[  554.569260] ILI_DATA:  0xff  0xff  0xff  0xff  0x53  0xe5  0x4b  0x01  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff
<4>[  554.569332] ILI_DATA:  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff
<4>[  554.569388] ILI_DATA:  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0x07  0x3f
<4>[  554.569388] ILI_DATA: ----------------------
<4>[  554.571040] ILI_DATA:  0x5a
<4>[  554.571064] ILI_DATA:  0xff  0xff  0xff  0xff  0x53  0xe8  0x2a  0x01  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff
<4>[  554.571134] ILI_DATA:  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff
<4>[  554.571169] ILI_DATA:  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0xff  0x07  0x5d
<4>[  554.571169] ILI_DATA: ----------------------
```
